...
func (*Manager) ParseCmd(flags *flag.FlagSet) {
	...
	reg.BoolWithEnv(&gcpcfg.UseSpotInstances, "use-spot-instances", false, "GCP_USE_SPOT_INSTANCES", "Use Spot (preemptible) instances for peer pod VMs. Reduces cost significantly but VMs may be reclaimed by GCP at any time.")
